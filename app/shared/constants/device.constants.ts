export const DEVICE_CATEGORY_VALUES = ['smartphone', 'wearable', 'accessory'] as const
...
export type DeviceAvailabilityValue = (typeof DEVICE_AVAILABILITY_VALUES)[number]

export const DEVICE_AVAILABILITY_LABELS: Record<DeviceAvailabilityValue, string> = {
  in: 'In stock',
  out: 'Out of stock'
}

export const DEVICE_SORT_VALUES = ['popular', 'price-asc', 'price-desc', 'name'] as const
...
export const isDeviceSortValue = (value: unknown): value is DeviceSortValue =>
  typeof value === 'string' && DEVICE_SORT_VALUES.includes(value as DeviceSortValue)
