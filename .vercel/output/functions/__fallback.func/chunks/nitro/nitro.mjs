...
var footer$2 = {
	tagline: "The smart way to choose devices."
};
var hero$2 = {
	badge: "Mini device catalog",
	title: "Device Hub",
	description: "Explore smartphones, wearables and accessories. Search, filter and compare key specifications in one clean catalog."
};
var catalog$2 = {
	filters: "Filters",
	...
	emptyText: "Try removing some filters or changing your search query.",
...
var device$2 = {
	...
	fallbackName: "Device",
	detailsDescription: "Detailed specifications and price for {name}.",
	catalog: "Catalog",
...
const locale_en_46json_b328a66e = {
	common: common$2,
	header: header$2,
	footer: footer$2,
	hero: hero$2,
...
var header$1 = {
	...
	switchToLight: "Schimba la tema luminoasa",
	switchToDark: "Schimba la tema intunecata",
	switchLanguage: "Schimba limba"
};
var footer$1 = {
	tagline: "Modul inteligent de a explora dispozitive."
};
var hero$1 = {
	badge: "Mini catalog de dispozitive",
	title: "Device Hub",
	description: "Exploreaza smartphone-uri, dispozitive purtabile si accesorii. Cauta, filtreaza si compara specificatiile cheie intr-un catalog curat."
};
var catalog$1 = {
	filters: "Filtre",
	devicesFound: "{count} dispozitive gasite",
	apiError: "Eroare API: {message}",
	sortDevices: "Sorteaza dispozitive",
	pagination: "Paginare",
	emptyTitle: "Nu s-a gasit nimic",
	emptyText: "Incearca sa elimini unele filtre sau sa schimbi textul cautarii.",
	resetFilters: "Reseteaza filtrele"
};
var filters$1 = {
	active: "Filtre active",
	noActive: "Nu exista filtre active",
	categories: "Categorii",
	brand: "Brand",
	price: "Pret",
	availability: "Disponibilitate",
	badges: "Etichete",
	minimumPrice: "Pret minim",
	maximumPrice: "Pret maxim",
	minimumPriceSlider: "Slider pret minim",
	maximumPriceSlider: "Slider pret maxim",
	modalTitle: "Filtre",
	closeFilters: "Inchide filtrele"
};
var activeFilter$1 = {
	search: "Cautare: {value}",
	category: "Categorie: {value}",
	brand: "Brand: {value}",
	badge: "Eticheta: {value}",
	price: "{min}–{max} MDL"
};
var device$1 = {
	image: "Imagine {name}",
	notFound: "Dispozitivul nu a fost gasit",
	fallbackName: "Dispozitiv",
	detailsDescription: "Specificatii detaliate si pret pentru {name}.",
	catalog: "Catalog",
...
const locale_ro_46json_a6a09939 = {
	common: common$1,
	header: header$1,
	footer: footer$1,
	hero: hero$1,
...
var footer = {
	tagline: "Умный способ выбирать устройства."
};
var hero = {
	badge: "Мини-каталог устройств",
	title: "Device Hub",
	description: "Смотрите смартфоны, носимые устройства и аксессуары. Ищите, фильтруйте и сравнивайте ключевые характеристики в одном удобном каталоге."
};
var catalog = {
	filters: "Фильтры",
	devicesFound: "Найдено устройств: {count}",
	apiError: "Ошибка API: {message}",
	sortDevices: "Сортировка устройств",
	pagination: "Пагинация",
	emptyTitle: "Ничего не найдено",
	emptyText: "Попробуйте убрать часть фильтров или изменить поисковый запрос.",
	resetFilters: "Сбросить фильтры"
};
var filters = {
	active: "Активные фильтры",
	noActive: "Нет активных фильтров",
	...
	minimumPriceSlider: "Ползунок минимальной цены",
	maximumPriceSlider: "Ползунок максимальной цены",
	modalTitle: "Фильтры",
...
var device = {
	...
	fallbackName: "Устройство",
	detailsDescription: "Подробные характеристики и цена для {name}.",
	catalog: "Каталог",
...
const locale_ru_46json_1076e869 = {
	common: common,
	header: header,
	footer: footer,
	hero: hero,
...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_b328a66e",
      load: () => Promise.resolve(locale_en_46json_b328a66e),
      cache: true
    }
  ],
  ro: [
    {
      key: "locale_ro_46json_a6a09939",
      load: () => Promise.resolve(locale_ro_46json_a6a09939),
      cache: true
    }
  ],
  ru: [
    {
      key: "locale_ru_46json_1076e869",
      load: () => Promise.resolve(locale_ru_46json_1076e869),
      cache: true
    }
  ]
};
...
const _RxCxCE6jCi9I4LG5vILsermjCGa59cWpSJm03TvoqC8 = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const _HymmvwR4B7ruGBh_k5tcNRh4egs0m2yAsPN1mRO4X4 = defineNitroPlugin((nitro) => {
...
const _rLlcWQqeSpAI1wU057vFJdKPctOxXFUIPvvx5NddRWk = defineNitroPlugin((nitro) => {
...
const plugins = [
  _RxCxCE6jCi9I4LG5vILsermjCGa59cWpSJm03TvoqC8,
_HymmvwR4B7ruGBh_k5tcNRh4egs0m2yAsPN1mRO4X4,
_rLlcWQqeSpAI1wU057vFJdKPctOxXFUIPvvx5NddRWk
];
...
const _zYWsOF = defineCachedEventHandler(async (event) => {
...
const _3IYXxj = _messagesHandlerCached;
...
const _aWGGXR = lazyEventHandler(() => {
...
const _lazy_ZXUpDx = () => import('../routes/api/devices.get.mjs');
const _lazy_mHItYk = () => import('../routes/api/devices/_slug_.get.mjs');
const _lazy_FbwM2n = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/devices', handler: _lazy_ZXUpDx, lazy: true, middleware: false, method: "get" },
  { route: '/api/devices/:slug', handler: _lazy_mHItYk, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_FbwM2n, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _zYWsOF, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _3IYXxj, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _aWGGXR, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_FbwM2n, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, klona as A, parseQuery as B, withQuery as C, sanitizeStatusCode as D, parseURL as E, decodePath as F, defuFn as G, getContext as H, parsePath as I, withTrailingSlash as J, withoutTrailingSlash as K, baseURL as L, hash$1 as M, executeAsync as N, getRequestURL as O, defu as P, getRequestHeader as Q, getCookie as R, isEqual as S, createDefu as T, setCookie as U, deleteCookie as V, isEqual$1 as W, withLeadingSlash as X, encodeParam as Y, listener as Z, devices as a, getRouterParam as b, createError$1 as c, defineEventHandler as d, buildAssetsURL as e, appRootTag as f, getQuery as g, appRootAttrs as h, appSpaLoaderTag as i, appSpaLoaderAttrs as j, appId as k, encodePath as l, defineRenderHandler as m, appTeleportTag as n, appTeleportAttrs as o, publicAssetsURL as p, appHead as q, destr as r, getRouteRules as s, getResponseStatusText as t, useRuntimeConfig as u, getResponseStatus as v, useNitroApp as w, hasProtocol as x, isScriptProtocol as y, joinURL as z };;globalThis.__timing__.logEnd('Load chunks/nitro/nitro');
