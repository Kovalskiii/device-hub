...
import { hasInjectionContext, inject, toRef, isRef, getCurrentScope, onScopeDispose, defineComponent, shallowRef, h, resolveComponent, getCurrentInstance as getCurrentInstance$1, computed, unref, defineAsyncComponent, createElementBlock, provide, cloneVNode, toValue, onServerPrefetch, reactive, useSSRContext, ref, Suspense, Fragment, createApp, createVNode, Text, mergeProps, shallowReactive, withCtx, createTextVNode, onErrorCaptured, resolveDynamicComponent, effectScope, nextTick, shallowReadonly, isReadonly, isShallow, isReactive, toRaw, customRef } from 'vue';
import { c as createError$1, x as hasProtocol, y as isScriptProtocol, z as joinURL, A as klona, B as parseQuery, C as withQuery, D as sanitizeStatusCode, E as parseURL, l as encodePath, F as decodePath, G as defuFn, H as getContext, I as parsePath, J as withTrailingSlash, K as withoutTrailingSlash, $ as $fetch$1, L as baseURL, M as hash, p as publicAssetsURL, N as executeAsync, O as getRequestURL, P as defu, Q as getRequestHeader, R as getCookie, S as isEqual, T as createDefu, U as setCookie, V as deleteCookie, W as isEqual$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BDQryw3f.mjs')
  },
  {
    name: "devices-slug___en",
    path: "/en/devices/:slug()",
    component: () => import('./_slug_-CgtaX9x4.mjs')
  },
  {
    name: "devices-slug___ro",
    path: "/ro/devices/:slug()",
    component: () => import('./_slug_-CgtaX9x4.mjs')
  },
  {
    name: "devices-slug___ru",
    path: "/ru/devices/:slug()",
    component: () => import('./_slug_-CgtaX9x4.mjs')
  },
  {
    name: "index___en",
...
const LazyIcon = defineAsyncComponent(() => import('./index-CDB7uKN6.mjs').then((r) => r["default"] || r.default || r));
  ...
  en: [
    {
      ...
      load: () => import(
        './en---GPZsEv.mjs'
        /* webpackChunkName: "locale_en_46json_b328a66e" */
      ),
      cache: true
    }
  ],
  ro: [
    {
      ...
      load: () => import(
        './ro-BH502SFJ.mjs'
        /* webpackChunkName: "locale_ro_46json_a6a09939" */
      ),
      cache: true
    }
  ],
  ru: [
    {
      ...
      load: () => import(
        './ru-DGWa5Jma.mjs'
        /* webpackChunkName: "locale_ru_46json_1076e869" */
      ),
      cache: true
    }
  ]
...
var define_I18N_LOCALE_HASHES_default$1 = { en: "5ccbc666", ro: "5ccbc666", ru: "5ccbc666" };
...
var define_I18N_LOCALE_HASHES_default = { en: "5ccbc666", ro: "5ccbc666", ru: "5ccbc666" };
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isVisible = computed(() => isInitialLoading.value || isLoading.value);
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(isVisible)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "app-loader" }, _attrs))}><div class="app-loader__backdrop"></div><div class="app-loader__spinner" role="status" aria-live="polite" aria-label="Loading page"></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/loader/AppLoader.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_0 = Object.assign(_sfc_main$3, { __name: "AppLoader" });
...
const _imports_0 = publicAssetsURL("/not-found.gif");
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "not-found" }, _attrs))}><section class="not-found__content" aria-labelledby="not-found-title"><h1 id="not-found-title" class="not-found__title"> Page not found </h1><img class="not-found__image"${ssrRenderAttr("src", _imports_0)} alt="404 not found illustration" draggable="false">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        class: "not-found__button",
        to: "/",
        onClick: ($event) => ("clearError" in _ctx ? _ctx.clearError : unref(clearError))()
      }, {
...
export { __nuxt_component_1$1 as _, useLocalePath as a, _export_sfc as b, useRoute as c, useRouter as d, entry_default as default, useAsyncData as e, createError as f, useSeoMeta as g, useState as h, useSwitchLocalePath as i, useNuxtApp as j, useRuntimeConfig as k, useHead as l, useRequestEvent as m, navigateTo as n, useAppConfig as o, useI18n as u };;globalThis.__timing__.logEnd('Load chunks/build/server');
